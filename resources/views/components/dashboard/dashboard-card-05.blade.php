<div class="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
    ...
    <div class="grow">
        <canvas id="dashboard-card-05" width="100" height="80"></canvas>
    </div>
</div>
...
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var ctx = document.getElementById('dashboard-card-05').getContext('2d');
            var chart = new Chart(ctx, {
                type: 'polarArea', // Choose your chart type
                data: {
